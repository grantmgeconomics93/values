...
final_df <- final_df%>%
  mutate(`Self positioning in political scale` = case_when(
    `Self positioning in political scale` == 1 ~ "Far Left",
    `Self positioning in political scale` == 2 ~ "Left",
    `Self positioning in political scale` == 3 ~ "Center-Left",
    ...
    `Self positioning in political scale` == 7 ~ "Center-Right",
    `Self positioning in political scale` == 8 ~ "Right",
    `Self positioning in political scale` == 9 ~ "Far Right",
    `Self positioning in political scale` == 10 ~ "Extreme Right",
