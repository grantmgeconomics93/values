...
exponential_fit_compressed<- fitdistr(data_vector1, "exponential")
...
# Assuming 'data_vector' is your data
data_vectortwo <- c(average_by_country_compressed$cheat) *10 # Replace with your actual data

# Fit a t-distribution
exponential_compressed<- fitdistr(data_vectortwo, "exponential")
